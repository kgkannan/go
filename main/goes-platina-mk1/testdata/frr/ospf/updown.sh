...
#	$D_MOVE up R1 eth-25-0 192.168.120.5/24
	$D_MOVE up R1 xeth1 192.168.120.5/24
#	$D_MOVE up R1 eth-4-0 192.168.150.5/24
	$D_MOVE up R1 xeth3 192.168.150.5/24
