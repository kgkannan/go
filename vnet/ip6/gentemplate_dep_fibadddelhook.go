...
// generated from gentemplate [gentemplate -id FibAddDelHook -d Package=ip6 -d DepsType=FibAddDelHookVec -d Type=FibAddDelHook -d Data=hooks github.com/platinasystems/go/elib/dep/dep.tmpl]
