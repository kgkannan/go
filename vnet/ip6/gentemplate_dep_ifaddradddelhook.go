...
// generated from gentemplate [gentemplate -id IfAddrAddDelHook -d Package=ip6 -d DepsType=IfAddrAddDelHookVec -d Type=IfAddrAddDelHook -d Data=hooks github.com/platinasystems/go/elib/dep/dep.tmpl]
