...
/**** TBDIP6: placeholder for mctrie ip6; copied from ip4/mctrie.go ***/
type leaf uint32
...
//go:generate gentemplate -d Package=ip6 -id ply -d PoolType=plyPool -d Type=ply -d Data=plys github.com/platinasystems/go/elib/pool.tmpl
